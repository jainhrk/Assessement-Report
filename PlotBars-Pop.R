...
plotbars<- function(data1, data2, data3, 
                    cap1 = "PopSize-35", cap2 = "PopSize-65", cap3 = "PopSize-280"){
  data = data1
  hues = c("red","purple","black")
  ...
  plot(df$x, df$y, type = "l", col = hues[1],  ylim=c(minn, maxx), #ylim = c(0.96, 0.985),   #choose ylim CAREFULLY as per your data ranges
        main = "TSP BEST Fitness Value", xlab = "Iterations", ylab = "Fitness Values")  #plot the line (mean values)
